...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-scrollbar', 'Comment.nvim', 'minimap.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
