...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'nvim-scrollbar', 'indent-blankline.nvim', 'minimap.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
