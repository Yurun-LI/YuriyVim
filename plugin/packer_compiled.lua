...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-scrollbar', 'Comment.nvim', 'minimap.vim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
